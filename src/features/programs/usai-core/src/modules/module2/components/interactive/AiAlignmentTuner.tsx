...
const AiAlignmentTuner: React.FC<InteractiveComponentProps> = ({ interactiveId }) => {
    ...
    const handleInteraction = () => {
        if (!hasInteracted && user && !user.progress.completedInteractives.includes(interactiveId)) {
            addPoints(15);
                ...
                <div className="space-y-6">
                    <div>
                        ...
                        <input
                            ...
                            max="100"
                            value={goal}
                            onChange={(e) => { setGoal(parseInt(e.target.value)); handleInteraction(); }}
                     ...
                     <div>
                        ...
                        <input
                            ...
                            max="100"
                            value={constraint}
                            onChange={(e) => { setConstraint(parseInt(e.target.value)); handleInteraction(); }}
                            className="w-full h-2 bg-brand-bg rounded-lg appearance-none cursor-pointer shadow-neumorphic-in"
                        />
                    </div>
                </div>
