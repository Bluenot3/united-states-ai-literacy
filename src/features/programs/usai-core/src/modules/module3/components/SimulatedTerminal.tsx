...
const SimulatedTerminal: React.FC<SimulatedTerminalProps> = ({ code, language, output, onRunCustomEffect, effectId }) => {
  ...
  return (
    <div className="bg-brand-bg rounded-lg my-6 p-2 shadow-neumorphic-in relative group">
       <div className="absolute -inset-1 bg-gradient-to-br from-brand-primary to-brand-secondary rounded-xl blur opacity-20 group-hover:opacity-40 transition duration-1000"></div>
