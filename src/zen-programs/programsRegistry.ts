...
const nonVanguardProgramManifests: ProgramManifest[] = [
    {
        ...
        dashboardCard: createDashboardCard({
            ...
            outcomes: [
                ...
                'Build with Gradio or Streamlit while handling API keys as secrets.',
                'Deploy a live Hugging Face Space and collect portfolio-ready showcase proof.',
            ],
            starterSteps: [
                'Start with the overview, then finish Module 1 before touching advanced tools.',
                'Use HF_TOKEN only as a Hugging Face Space Secret, never in code, README files, screenshots, chat, public repos, or localStorage.',
                'Launch the first Gradio or Streamlit Space by week 4 or week 5.',
                'Document one finished project with the public Space URL, screenshots, prompt examples, and what you learned.',
            ],
