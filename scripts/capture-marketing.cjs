...
async function captureScreenshots() {
  ...
  const routes = [
    { name: '01_hub_overview_highres', path: '/hub', wait: 3500, fullPage: true },
    { name: '02_dashboard_analytics_highres', path: '/dashboard', wait: 3500, fullPage: true },
    { name: '03_profile_pioneer_highres', path: '/profile', wait: 2000, fullPage: true },
    { name: '04_module1_execution_highres', path: '/module/1/overview', wait: 3000, fullPage: true },
    { name: '05_module2_workspace_highres', path: '/module/2/overview', wait: 3000, fullPage: true },
    { name: '06_module3_sandbox_highres', path: '/module/3/overview', wait: 3000, fullPage: true },
    { name: '07_module4_deployment_highres', path: '/module/4/overview', wait: 3000, fullPage: true },
